...
'Olympic.webp'),
(7,7,'First Republic Bank Frankfurt-listed shares rise after rescue',
'LONDON, March 17 (Reuters) - The Frankfurt-listed shares banks injected $30 billion in deposits into the beleaguered lender on Thursday.',
...
However, while First Republics stock closed up 10% on news of the rescue, its shares fell 17% in after-market trading after the bank said it would suspend its dividend and disclosed its cash position and just how much emergency liquidity it needed.
